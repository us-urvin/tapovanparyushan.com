...
<form id="shanghLoginForm">
    ...
    <div class="mb-6">
        ...
        <input type="text" id="mobile" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#C9A14A] placeholder:text-gray-400" placeholder="Enter Mobile Number">
    ...
    <div id="userInfo" class="hidden mb-6">
        ...
        <div class="mb-4">
            ...
            <input type="email" id="email" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#C9A14A] placeholder:text-gray-400" readonly>
        </div>
    </div>
    <button id="sendOtpBtn" type="button" class="w-full bg-[#C9A14A] text-white py-2 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#b38e3c] transition">
